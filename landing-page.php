...
<body>
  ...
  <section id="#title">
    <div class="container-header">
      <nav class="navbar navbar-expand-lg nav-dark">
        ...
        <a href="Entry_page.php" class="btn btn-md btn-outline-primary ms-auto">Log in</a>
        <a href="Entry_page.php" class="btn btn-md btn-primary" style="margin-left: 7px;" aria-current="page">Sign Up</a>
        </ul>
      </nav>
    </div>
  </section>
  ...
  <section class="container-body">
    <div class="row">
      <div class="col container-body-contents">
        <h2>Arrange</h2>
        <h1>Participate</h1>
        <h3>Get Result</h3>
      ...
      <div class="col">
          <img class="card-image-top" alt="80%x80%" src="image/landing-page.jpg">
      </div>
