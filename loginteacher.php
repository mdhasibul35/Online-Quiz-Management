				...
				<div class="box-wrapper">				
					<div class="box box-border">
						...
						<center> <h5 style="font-family: Noto Sans;">Login to </h5><h4 style="font-family: Noto Sans;">Online Quiz System</h4></center><br>
							<form method="post" action="loginteacher.php" enctype="multipart/form-data">
								...
								<div class="form-group text-center">
									<span class="text-muted">Don't have an account?</span> <a href="loginteacher.php">Register</a> Here..
								</div>
							</form>
						</div>
					</div>
